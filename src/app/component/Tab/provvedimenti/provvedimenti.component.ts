...
import { AddProvvedimentiComponent } from "../../add-edit/add-edit-provvedimenti/add-provvedimenti.component";
...
export class ProvvedimentiComponent implements OnInit {
  ...
  onClickAddProvvedimenti() {
    const dialogRef = this.dialog.open(AddProvvedimentiComponent, {
      width: "40vw",
    });
