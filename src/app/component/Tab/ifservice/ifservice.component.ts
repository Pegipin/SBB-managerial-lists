...
import { AddIfserviceComponent } from "../../add-edit/add-edit-fservice/add-ifservice.component";
...
@Component({
  ...
  templateUrl: "./ifservice.component.html",
  styleUrls: ["./ifservice.component.css"],
})
export class IfserviceComponent implements OnInit {
  ...
  onClickAddIfService() {
    const dialogRef = this.dialog.open(AddIfserviceComponent, {
      width: "40vw",
    });
