...
@Component({
  ...
  templateUrl: "./add-contesti.component.html",
  styleUrls: ["./add-contesti.component.css"],
})
export class AddContestiComponent implements OnInit {
  id: any;
  ...
  constructor(
    ...
    private selfDialogRef: MatDialogRef<AddContestiComponent>
  ) {}
