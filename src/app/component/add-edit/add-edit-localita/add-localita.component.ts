...
@Component({
  ...
  templateUrl: "./add-localita.component.html",
  styleUrls: ["./add-localita.component.css"],
})
export class AddLocalitaComponent implements OnInit {
  id: any;
  ...
  constructor(
    ...
    private selfDialogRef: MatDialogRef<AddLocalitaComponent>
  ) {}
