...
@Component({
  ...
  templateUrl: "./add-ifservice.component.html",
  styleUrls: ["./add-ifservice.component.css"],
})
export class AddIfserviceComponent implements OnInit {
  id: any;
  ...
  constructor(
    ...
    private selfDialogRef: MatDialogRef<AddIfserviceComponent>
  ) {}
