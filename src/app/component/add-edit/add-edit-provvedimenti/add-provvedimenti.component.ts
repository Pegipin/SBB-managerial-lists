...
@Component({
  ...
  templateUrl: "./add-provvedimenti.component.html",
  styleUrls: ["./add-provvedimenti.component.css"],
})
export class AddProvvedimentiComponent implements OnInit {
  id: any;
  ...
  constructor(
    ...
    private selfDialogRef: MatDialogRef<AddProvvedimentiComponent>
  ) {}
